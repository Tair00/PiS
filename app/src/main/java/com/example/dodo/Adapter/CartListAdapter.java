...
public class CartListAdapter extends RecyclerView.Adapter<CartListAdapter.ViewHolder>{
    ArrayList<OrderDomain> listFoodSelected;
    private ManagementCart managementCart;
    ChangeNumberItemsListener changeNumberItemsListener;

    public CartListAdapter(ArrayList<OrderDomain> listFoodSelected, Context context, ChangeNumberItemsListener changeNumberItemsListener) {
    ...
    public void onBindViewHolder(@NonNull CartListAdapter.ViewHolder holder, int position){
        ...
        holder.feeEachItem.setText( Math.round(listFoodSelected.get(position).getNumberInCart()*listFoodSelected.get(position).getFee())+"руб");
